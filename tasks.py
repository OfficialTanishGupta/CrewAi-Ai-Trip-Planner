...
class TravelTasks:
    ...
    def plan_itinearary(self, agent, city, travel_dates, interests):
        return Task(
            description=dedent(
                f"""
            **Task**: Develop a 7-Day Travel Ititnary
    ...
    def identify_city(self, agent, origin, citites ,interests , travel_dates):
        return Task(
            description=dedent(
                f"""
